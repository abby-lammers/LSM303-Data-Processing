...
#### STEP 5: WINDROSE PLOT ####

# 5.1 I assume I'm going to need a frequency table 
...
# iteration 2: break down by month (to show some semblance of cumulative)

# plot that's polar but scales to the range 
plot_ly(
  data = AngleFrequencyTable,
  type = 'area',
  t = ~Angle,
...
## add tilt calculation as velocity proxy
## length of the vector
## it's a triangle ! So you can kind of get velocity but it doesn't matter because it's all just ~ratios~